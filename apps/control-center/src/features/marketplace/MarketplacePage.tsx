...
export function MarketplacePage() {
  ...
  const [selectedPackage, setSelectedPackage] = createSignal<any>(null);
  ...
  const filteredPackages = () => {
    ...
    return pkgs.filter((p: any) => p.category === cat);
  };
      ...
      <Show when={selectedPackage()}>
        <div class="panel panel-pad" style={{ 'margin-top': '1rem' }}>
          ...
          <Show when={selectedPackage().documentation_url}>
            <p>
              <a href={selectedPackage().documentation_url} target="_blank" rel="noreferrer">
                Documentation
              </a>
            </p>
          </Show>
          <Show when={selectedPackage().source_url}>
            <p>
              <a href={selectedPackage().source_url} target="_blank" rel="noreferrer">
                Source Code
              </a>
            </p>
          </Show>
